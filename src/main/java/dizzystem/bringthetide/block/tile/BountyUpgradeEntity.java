...
public class BountyUpgradeEntity extends CoreEntity implements UpgradeCoreEntity {
    ...
    public BountyUpgradeEntity(BlockPos blockPos, BlockState blockState){
        super(TideBlocks.BOUNTY_UPGRADE_ENTITY.get(), blockPos, blockState);
    }
